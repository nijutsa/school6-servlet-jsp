...
<body>
            ...
            <div class="container">
                ...
                <form method="POST" action="${pageContext.request.contextPath}/login">
                    ...
                    <div class="row">
                        ...
                        <span></span>
                        <div class="row">
                            <button type="button" id="showPasswordButton" onclick="showPassword()">Show Password</button>
                        </div>
                    </div>
                    <div class="row">
    ...
    <script src="${pageContext.request.contextPath}/js/show-password.js"></script>
</body>
</html>